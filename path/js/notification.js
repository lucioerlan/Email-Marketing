function notifyMe(_0x6463x2, _0x6463x3, _0x6463x4) {
    if(!("Notification" in window)) {
        ...
        if(Notification.permission === "granted") {
            ...
            var _0x6463x6 = new Notification("[Email Marketing] " + _0x6463x3, _0x6463x5)
        } else {
...
function limpar() {
    ...
    if(_0x6463xb.length == 0) {
        ...
        notifyMe("Nós não consiguimos limpar algo que já está limpo!", "Erro a limpar a lista.");
        audio2.play();
        return
    } else {
        ...
        audio.play();
        notifyMe("Todas os e-mails que estavam na sua lista foram limpos!", "Lista limpa.")
    }
}
...
function start() {
    ...
    if(_0x6463xb.length == 0) {
        ...
        notifyMe("Você precisa carregar uma lista antes de iniciar!", "Erro ao iniciar.");
        audio2.play();
        return
    } else {
        document.getElementById("demo").innerHTML = "<div class=\"label label-warning label-dismissible\">Iniciado.</div>";
        audio.play();
        notifyMe("Seus e-mails foram enviados com sucesso, estamos iniciando!", "Iniciando.")
    };
    var _0x6463x10;
    var _0x6463xb = $("#ccs").val();
...
function pushcsB(_0x6463x2e, _0x6463x2f) {
    document.getElementById(_0x6463x2f).innerHTML = document.getElementById(_0x6463x2f).innerHTML + _0x6463x2e + "\n<br>"
}